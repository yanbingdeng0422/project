package com.xxun.input.keyboard;
...
import com.xxun.input.MyInputMethodService;
import com.xxun.input.R;
import com.xxun.input.constants.DemoKeyCode;
import com.xxun.input.util.MyUtil;
...
//        initKeyboardView(context);
    ...
    private void initKeyboardView(Context context) {
        mKeyboardLetter = new Keyboard(context, R.xml.letter);
        mKeyboardNum = new Keyboard(context, R.xml.num);
...
//        float x = me.getX();
//        float y = me.getY();
//        Log.d("yanbing","x=" +x+" y="+y);
//
//        switch (me.getAction()) {
//
//            case MotionEvent.ACTION_DOWN:
//                Log.d("yanbing","ACTION_DOWN x=" +x);
//                mDownX = x;
//                mDownY = y;
//                break;
